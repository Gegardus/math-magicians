...
const Home = () => (
  <main className="home-content">
    ...
    <p className="home-quote">
    When intuition and logic agree, you are always right . . Our notion of symmetry is derived form the human face. Hence, we demand symmetry horizontally and in breadth only, not vertically nor in depth.
    </p>
  </main>
);
